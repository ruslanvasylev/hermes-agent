...
| `SAKANA_API_KEY` | Sakana Fugu API key ([console.sakana.ai](https://console.sakana.ai/)) |
| `SAKANA_BASE_URL` | Override Sakana Fugu base URL (default: `https://api.sakana.ai/v1`) |
